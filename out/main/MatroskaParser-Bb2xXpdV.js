...
const main = require("./main-Dq_aMfL8.js");
          ...
          case 307544935:
            {
              ...
              await Promise.all(tags.tag.map(async (tag) => {
                ...
                const targetType = (target == null ? void 0 : target.targetTypeValue) ? main.TargetType[target.targetTypeValue] : (target == null ? void 0 : target.targetType) ? target.targetType : "track";
